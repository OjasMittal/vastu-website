			...
			>
				...
				>
					<p>
						...
						office for growth, clarity, and prosperity.
					</p>
					...
					<ul className='list-disc ml-6 space-y-3'>
						<li>
							A MahaVastu certified surveyor prepares a precise to-scale plan of
							your office, noting directions and placements of activities,
							useful items, and décor elements.
						</li>
						<li>
							Comprehensive auditing is done by MahaVastu experts based on these
							surveyed maps.
						</li>
						<li>
							Problems like{" "}
					...
					<p>
						With our step-by-step correction plan, your office transforms into a
						powerhouse of productivity, profits, and positivity.
					</p>
				</motion.div>
			</motion.div>
